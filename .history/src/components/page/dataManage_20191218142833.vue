      ...
      this.$axios({
        ...
        .then(function(response) {
          ...
          for( var w=0;w<ss.length;w++ ) {
            res.ActivityLevelTime.push(ss[w].time)
            res.notActivityCounts.push(ss[w].notActivityCount)
            res.activityCounts.push(ss[w].activityCount)
          }
