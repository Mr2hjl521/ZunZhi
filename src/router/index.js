    ...
    routes: [{
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/phoneModule',
                    component: resolve => require(['../components/page/phoneModule.vue'], resolve),
                    meta: { title: '手机膜管理' }
                },
                //库存管理
                {
                    path: '/repertoryManage',
                    component: resolve => require(['../components/page/repertoryManage.vue'], resolve),
                    meta: { title: '库存管理' }
                },
                //库存管理
                {
                    path: '/giveManage',
                    component: resolve => require(['../components/page/giveManage.vue'], resolve),
                    meta: { title: '首次派发' }
                },
                //配比列表
                {
                    path: '/matching',
                    component: resolve => require(['../components/page/matching.vue'], resolve),
                    meta: { title: '配比列表' }
                },
                //服务人员
                {
