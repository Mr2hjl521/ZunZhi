  ...
  <div class="carManager">
    ...
    <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
      <el-form ref="editForm" :model="editForm" label-width="100px">
        ...
        <el-form-item label="身份" prop="serviceTypeName">
			<!-- 身份是下拉框 -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios({
      	url: 'http://39.99.137.77:8081/projects/serviceUser/findAllServiceUserPhoneForPC?pageNum='+res.cur_page+'&pageSize='+ res.pagesize,
        method: 'get',
      	data: {  }
      })
